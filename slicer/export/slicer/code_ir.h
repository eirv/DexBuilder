...
struct String : public IndexedOperand {
  ...
  String(ir::String* ir_string, dex::u4 index)
      : IndexedOperand(index), ir_string(ir_string) {}
...
struct Type : public IndexedOperand {
  ...
  Type(ir::Type* ir_type, dex::u4 index)
      : IndexedOperand(index), ir_type(ir_type) {}
...
struct Field : public IndexedOperand {
  ...
  Field(ir::FieldDecl* ir_field, dex::u4 index)
      : IndexedOperand(index), ir_field(ir_field) {}
...
struct Method : public IndexedOperand {
  ...
  Method(ir::MethodDecl* ir_method, dex::u4 index)
      : IndexedOperand(index), ir_method(ir_method) {
...
struct MethodHandle : public IndexedOperand {
  ...
  MethodHandle(ir::MethodHandle* ir_method_handle, dex::u4 index)
      : IndexedOperand(index), ir_method_handle(ir_method_handle) {
...
struct Proto : public IndexedOperand {
  ...
  Proto(ir::Proto* ir_proto, dex::u4 index)
      : IndexedOperand(index), ir_proto(ir_proto) {}
...
struct LineNumber : public Operand {
  ...
  explicit LineNumber(int line) : line(line) { SLICER_WEAK_CHECK(line >= 0); }
...
struct CodeIr {
 ...
 private:
  ...
  void FixupPackedSwitch(PackedSwitchPayload* instr, dex::u4 base_offset,
                         const dex::u2* ptr);
  void FixupSparseSwitch(SparseSwitchPayload* instr, dex::u4 base_offset,
                         const dex::u2* ptr);

  SparseSwitchPayload* DecodeSparseSwitch(const dex::u2* /*ptr*/,
                                          dex::u4 offset);
  PackedSwitchPayload* DecodePackedSwitch(const dex::u2* /*ptr*/,
                                          dex::u4 offset);
  ArrayData* DecodeArrayData(const dex::u2* ptr, dex::u4 offset);
  Bytecode* DecodeBytecode(const dex::u2* ptr, dex::u4 offset);

  IndexedOperand* GetIndexedOperand(dex::InstructionIndexType index_type,
                                    dex::u4 index);
  IndexedOperand* GetSecondIndexedOperand(dex::InstructionIndexType index_type,
                                          dex::u4 index);
